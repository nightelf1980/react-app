...
const ItemCart = ({ product }) => {
    ...
    return (
        <tr>
            <td className="align-middle text-center"><img src={"../../img/products/" + product.image} width="100px" alt={product.title} title={product.title}/></td>
            ...
            <td class="align-middle text-center" width="50"><Link to="#!" class="btn" title="Quitar del carro"><i class="fa-solid fa-trash"></i></Link></td>
        </tr>
    )
}
